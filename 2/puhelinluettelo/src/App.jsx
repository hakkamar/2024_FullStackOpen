      ...
      if (
        ...
        personService
          ...
          .catch((error) => {
            ...
            setMessuMessage(
              `Person '${muutettava.name}' was already removed from server (by someone else?)`
            );
          });
        setNewName("");
        setNewNumber("");
    ...
    // Nimi ei ole muistiossa, joten lisätään se sinne...
      ...
      personService
        ...
        .catch((error) => {
          ...
          setMessuMessage(
            `Add '${nameAndNumberObject.name}' to Phonebook fails...`
          );
        });
      setNewName("");
      setNewNumber("");
    ...
    if (window.confirm(`Delete ${potenttiaalinenPoistettava.name} ?`)) {
      personService
        ...
        .catch((error) => {
          ...
          setMessuMessage(
            `Person '${potenttiaalinenPoistettava.name}' delete fails.... was already removed from server?`
          );
        });
    }
    setTimeout(() => {
